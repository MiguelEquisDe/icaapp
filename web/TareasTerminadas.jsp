        ...
        <div class="cuerpo">
            ...
            <div class="contenido">
                ...
                <div class="conte col-sm-12">
                    ...
                    <center>
                        <a href="ControladorCasino?menu=datos&accion=Borrar&id_casino=<%= reM.getId_casino()%>" style="float: right;" class="txtbtn btn btn-outline-success">
                            <b>Finalizar</b>
                        </a>
                    </center>
                    <center>
                        <a href="ControladorCasino?menu=datos&accion=establecer0&id_casino=<%= reM.getId_casino()%>" style="float: right;" class="txtbtn btn btn-outline-warning">
                            <b>Reasignar</b>
                        </a>
                    </center>
                </div>
